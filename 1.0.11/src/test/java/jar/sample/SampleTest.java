...
import java.util.*;
import jar.model.Cat;
import jar.model.Person;
import jar.view.CatSimpleView;
import jar.repository.CatSimpleViewRepository;
...
public class SampleTest extends AbstractSampleTest {
    ...
    @EnableEntityViews(basePackages = { "jar.view"})
    @EnableJpaRepositories(
            basePackages = "jar.repository",
